...
import pl.edu.pbs.zwinnebackend.security.JwtAuthenticationEntryPoint;
import pl.edu.pbs.zwinnebackend.security.JwtAuthenticationFilter;
...
@Configuration
@EnableWebSecurity
@EnableMethodSecurity // Umożliwia używanie adnotacji @PreAuthorize
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Zezwól na zapytania z dowolnego źródła dla prostoty deweloperskiej, lub zdefiniuj precyzyjnie port Vite
